			...
			<div class="rowContainer" id="container_MyAccountDisplayB2B">
				<div class="row margin-true">
					...
					<div class="col8 acol12 ccol9 right">
						...
						<%out.flush();%>
							<wcpgl:widgetImport useIBMContextInSeparatedEnv="${isStoreServer}" url="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.RequisitionListUploadDetails/RequisitionListUploadDetails.jsp">  
